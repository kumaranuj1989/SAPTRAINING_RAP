  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF issue_message,
        msgid TYPE symsgid VALUE 'YDEMO_MSGCLASS',
    ...
    METHODS constructor
      IMPORTING
        ...
        classid      TYPE ydemo_class_id OPTIONAL.
    ...
    DATA   classid      TYPE ydemo_class_id READ-ONLY.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
CLASS ycl_demo_msg IMPLEMENTATION.
